...
const ZACC = {
    ...
    calculerZACCPourDirection: function(donnees, directionNom) {
        ...
        donnees.forEach(function(d) {
            ...
            if (ZACC.pariteActuelle === 'paire') {
                // المجالات الزوجية: 1999-4000, 4001-6000, 6001-8000, ...
                if (pk < 1999) return; // Ignorer les PK hors plage
                ...
                if (pk <= 4000) {
                    ...
                    var offset = pk - 4001;
                    var cycle = Math.floor(offset / 2000);
                    sectionStart = 4001 + cycle * 2000;
                    sectionEnd = sectionStart + 1999;
                }
            } else {
                // المجالات الفردية: 999-3000, 3001-5000, 5001-7000, ...
                if (pk < 999) return; // Ignorer les PK hors plage
    ...
    getDatesPourSection: function(sectionStart, sectionEnd, direction, donnees) {
        ...
        var accidentsSection = donnees.filter(function(d) {
            ...
            // ✅ Changé: pk <= sectionEnd au lieu de pk < sectionEnd
